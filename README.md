...
Neste curso mergulhamos a fundo na construção de um Sistema de Gestão Empresarial completo utilizando tecnologias de última geração: Django Rest Framework e trabalahndo para a implementação do fornt com o React
